...
describe("UserController integration", () => {
  ...
  describe("Get User", () => {
    ...
    it("Get User: NotFoundError (user inesistente)", async () => {
      ...
      await expect(userController.getUser("nonexistent")).rejects.toThrow(
        NotFoundError
      );
      expect(mockUserRepository.getUserByUsername).toHaveBeenCalledWith(
        "nonexistent"
  ...
  describe("Delete User", () => {
    ...
    it("Delete User: NotFoundError (user inesistente) ", async () => {
      ...
      await expect(userController.deleteUser("nonexistent")).rejects.toThrow(
        NotFoundError
      );
    ...
    it("Delete User: Gestione errori del database durante l'eliminazione", async () => {
      ...
      await expect(userController.deleteUser("testuser")).rejects.toThrow(
